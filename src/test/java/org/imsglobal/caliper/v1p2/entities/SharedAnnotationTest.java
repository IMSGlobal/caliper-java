...
public class SharedAnnotationTest {
    private SharedAnnotation entity;
    ...
    public void setUp() throws Exception {
        ...
        entity = SharedAnnotation.builder()
            ...
            .annotated(Document.builder().id(BASE_IRI.concat("/etexts/201.epub")).build())
            .withAgents(Lists.newArrayList(
            		Person.builder().id(BASE_IRI.concat("/users/657585")).build(),
            		Person.builder().id(BASE_IRI.concat("/users/667788")).build()
            		))
    ...
    public void caliperEntitySerializesToJSON() throws Exception {
        ...
        String fixture = jsonFixture("fixtures/v1p2/caliperEntitySharedAnnotation.json");
