...
public class ChapterTest {
    ...
    private static final String BASE_IRI = "https://example.com/#/texts/imscaliperimplguide";
    
    @Before
    public void setUp() throws Exception {

        entity = Chapter.builder()
            .context(JsonldStringContext.create(CaliperJsonldContextIRI.V1P2.value()))
            .id(BASE_IRI.concat("/cfi/6/10"))
    ...
    public void caliperEntitySerializesToJSON() throws Exception {
        ...
        String fixture = jsonFixture("fixtures/v1p2/caliperEntityChapter.json");
