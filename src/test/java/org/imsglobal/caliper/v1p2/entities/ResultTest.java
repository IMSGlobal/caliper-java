...
public class ResultTest {
    ...
    public void setUp() throws Exception {
        ...
        entity = Result.builder()
            ...
            .id(BASE_IRI.concat("/terms/201601/courses/7/sections/1/assess/1/users/554433/attempts/1/results/1"))
    ...
    public void caliperEntitySerializesToJSON() throws Exception {
        ...
        String fixture = jsonFixture("fixtures/v1p2/caliperEntityResult.json");
