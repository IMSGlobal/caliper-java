...
public class FillinBlankResponseTest {
	
    private FillinBlankResponse entity;
    private static final String BASE_IRI = "https://example.edu";
    
    @Before
    public void setUp() throws Exception {

        entity = FillinBlankResponse.builder()
            .context(JsonldStringContext.create(CaliperJsonldContextIRI.V1P2.value()))
            .id(BASE_IRI.concat("/terms/201601/courses/7/sections/1/assess/1/items/1/users/554433/responses/1"))
            .attempt(Attempt.builder()
            		.id(BASE_IRI.concat("/terms/201601/courses/7/sections/1/assess/1/items/1/users/554433/attempts/1"))
            		.assignee(Person.builder()
            				.id(BASE_IRI.concat("/users/554433"))
            				.build())
            		.assignable(AssessmentItem.builder()
            				.id(BASE_IRI.concat("/terms/201601/courses/7/sections/1/assess/1/items/1"))
            ...
            .startedAtTime(new DateTime(2016, 11, 15, 10, 15, 2, 0, DateTimeZone.UTC))
            .endedAtTime(new DateTime(2016, 11, 15, 10, 15, 12, 0, DateTimeZone.UTC))
            .values(Lists.newArrayList("data interoperability", "semantic interoperability" ))            
            .build();
    }
    ...
    public void caliperEntitySerializesToJSON() throws Exception {
        ...
        String fixture = jsonFixture("fixtures/v1p2/caliperEntityFillinBlankResponse.json");
