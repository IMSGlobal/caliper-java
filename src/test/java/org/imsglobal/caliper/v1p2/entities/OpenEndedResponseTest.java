...
public class OpenEndedResponseTest {
    ...
    private OpenEndedResponse entity;
    private static final String BASE_IRI = "https://example.edu";
    
    @Before
    public void setUp() throws Exception {

        entity = OpenEndedResponse.builder()
            .context(JsonldStringContext.create(CaliperJsonldContextIRI.V1P2.value()))
            .id(BASE_IRI.concat("/surveys/100/questionnaires/30/items/2/users/554433/responses/2"))
            .value("I feel that ...")
    ...
    public void caliperEntitySerializesToJSON() throws Exception {
        ...
        String fixture = jsonFixture("fixtures/v1p2/caliperEntityOpenEndedResponse.json");
