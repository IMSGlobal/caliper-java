...
public class QuestionnaireItemTest {
    private QuestionnaireItem entity;
    ...
    public void setUp() throws Exception {
        ...
        entity = QuestionnaireItem.builder()
            .context(JsonldStringContext.create(CaliperJsonldContextIRI.V1P2.value()))
            .id(BASE_IRI.concat("/surveys/100/questionnaires/30/items/1"))
            .question(RatingScaleQuestion.builder()
            		.id(BASE_IRI.concat("/surveys/100/questionnaires/30/items/1/question"))
            		.questionPosed("How satisfied are you with our services?")
            		.scale(LikertScale.builder()
            				.id(BASE_IRI.concat("/scale/2"))
            				.scalePoints(4)
            				.itemLabels(Lists.newArrayList("Strongly Disagree", "Disagree", "Agree", "Strongly Agree"))
            				.itemValues(Lists.newArrayList("-2", "-1", "1", "2"))
            				.build())
            		.build())
            .categories(Lists.newArrayList("teaching effectiveness", "Course structure"))
            .weight(1.0)
            .build();
    }
    ...
    public void caliperEntitySerializesToJSON() throws Exception {
        ...
        String fixture = jsonFixture("fixtures/v1p2/caliperEntityQuestionnaireItem.json");
