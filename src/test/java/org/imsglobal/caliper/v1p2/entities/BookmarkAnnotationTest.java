...
public class BookmarkAnnotationTest {
    ...
    private BookmarkAnnotation entity;
    private static final String BASE_IRI = "https://example.com";
    
    @Before
    public void setUp() throws Exception {

        entity = BookmarkAnnotation.builder()
            .context(JsonldStringContext.create(CaliperJsonldContextIRI.V1P2.value()))
            .id(BASE_IRI.concat("/users/554433/texts/imscaliperimplguide/bookmarks/1"))
    ...
    public void caliperEntitySerializesToJSON() throws Exception {
        ...
        String fixture = jsonFixture("fixtures/v1p2/caliperEntityBookmarkAnnotation.json");
