...
public class MultiselectScaleTest {
	
    private MultiselectScale entity;
    ...
    public void setUp() throws Exception {
        ...
        entity = MultiselectScale.builder()
    ...
    public void caliperEntitySerializesToJSON() throws Exception {
        ...
        String fixture = jsonFixture("fixtures/v1p2/caliperEntityMultiselectScale.json");
