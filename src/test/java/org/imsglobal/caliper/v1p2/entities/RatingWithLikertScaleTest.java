...
public class RatingWithLikertScaleTest {
        ...
        entity = Rating.builder()
            ...
            .question(RatingScaleQuestion.builder()
            		...
            		.scale(LikertScale.builder()
            				...
            				.build())            		
            		.build())
            .selections(Lists.newArrayList("1"))
    ...
    public void caliperEntitySerializesToJSON() throws Exception {
        ...
        String fixture = jsonFixture("fixtures/v1p2/caliperEntityRatingWithLikertScale.json");
