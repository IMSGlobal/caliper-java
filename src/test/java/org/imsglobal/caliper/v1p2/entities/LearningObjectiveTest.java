...
import org.imsglobal.caliper.entities.resource.LearningObjective;
...
public class LearningObjectiveTest {
    ...
    private LearningObjective entity;
        
    @Before
    public void setUp() throws Exception {

        entity = LearningObjective.builder()
    ...
    public void caliperEntitySerializesToJSON() throws Exception {
        ...
        String fixture = jsonFixture("fixtures/v1p2/caliperEntityLearningObjective.json");
