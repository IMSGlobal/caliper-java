...
public class EnvelopeTermLisStatusTest {
    ...
    public void setUp() throws Exception {
		...
		for (Status status : Status.values()) {			
			entities.add(Membership.builder()
					...
					.status(status)
					.roles(Lists.newArrayList(Role.ADMINISTRATOR))
					.build());
		}
    ...
    public void caliperEnvelopeSerializesToJSON() throws Exception {
        ...
        String fixture = jsonFixture("fixtures/v1p2/caliperEnvelopeTermLISStatus.json");
