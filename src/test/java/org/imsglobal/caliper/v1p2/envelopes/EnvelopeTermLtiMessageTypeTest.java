...
public class EnvelopeTermLtiMessageTypeTest {
	
	private Envelope envelope;
	
	private static final String BASE_IRI = "https://example.edu";
	private static final String ID = "http://purl.imsglobal.org/caliper/LtiLink";
    ...
    public void setUp() throws Exception {
		...
		for (LtiMessageType msgType : LtiMessageType.values()) {			
			entities.add(LtiLink.builder()
    ...
    public void caliperEnvelopeSerializesToJSON() throws Exception {
        ...
        String fixture = jsonFixture("fixtures/v1p2/caliperEnvelopeTermLTIMessageType.json");
